...
namespace PROCESS
{
    ...
    /* TODO: Implement priority queue (binary tree)
     * TODO: context switch
     * TODO: Define stack space (with VM) for each process
     * TODO: String library
     * TODO: printf with format
     */
    ...
    void Initialize()
    {
        ProcessEntry *Process    = (ProcessEntry*) KM::kmalloc(sizeof(ProcessEntry));
        proctab[process_count++] = Process;
        void *Stack              = KM::kmalloc(STACK_SIZE);
    ...
    //{
    //    // TODO: save general purpose registers
    //    // TODO: save hardware register
    //    // TODO: save and restore stack pointer
    //}

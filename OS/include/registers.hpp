...
namespace CR0
{
    ...
    {            //  | name                    | description
        ...
        MP = 1,  ///< <pre>Monitor coprocessor | Set to allow ma.hpp coprocessor instruction execution                   </pre>
        EM = 2,  ///< <pre>Emulation           | Set to use software emulation for x87 floating-point instruction      </pre>
        TS = 3,  ///< <pre>Task switched       | Set to delay saving of x87 FPU, SSE on task swit.hpp till actually used </pre>
        ...
        NW = 29, ///< <pre>Not write-throu.hpp   | Clear to enable write-back/write-throu.hpp                              </pre>
